...
namespace API_GroupDetail.Factories.CompleteSessionFactory
{
    public class CompleteSessionEmatInfantilCalculator : CompleteSesssionCalculator
    {
        ...
        {
            if (studentAnwsers.All(b => b.Grade >= 0) && studentAnwsers.Count == Config.Config.StageCountInEmatInfantilSession)
                return true;
            return false;
        }
        ...
        {
            return Config.Config.MaxDifficultyEmatInfantil;
        }

        public override int StagesForForwardSuccessfuly()
        {
            return Config.Config.StageCountInEmatInfantilSession;
        }
    }
}
